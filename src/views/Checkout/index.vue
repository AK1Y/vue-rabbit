...
const createOrder = async () => {
  ...
  //更新购物车
  cartStore.cartList = cartStore.cartList.filter(item=>!item.selected)
}
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <table class="goods">
            ...
            <tbody>
              <tr v-for="i in cartStore.cartList.filter(item => item.selected)" :key="i.skuId">
                <td>
        ...
        <div class="box-body">
          <div class="total">
            ...
            <dl>
              <dt>应付总额：</dt>
              <dd class="price">
                {{ (cartStore.selectedPrice + (checkInfo.summary?.postFee || 0)).toFixed(2) }}
              </dd>
            </dl>
          </div>
        </div>
